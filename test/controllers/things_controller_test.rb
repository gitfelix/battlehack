...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { description: @thing.description, image: @thing.image, lat: @thing.lat, lng: @thing.lng, name: @thing.name }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { description: @thing.description, image: @thing.image, lat: @thing.lat, lng: @thing.lng, name: @thing.name }
    assert_redirected_to thing_path(assigns(:thing))
  end
